...
\item[11.72]Find the characteristic and minimum polynomials of each matrix:
	...
	This matrix has the block matrices
	\[ A=\begin{bmatrix}[rr]3&2\\1&4\\\end{bmatrix}, \quad B=\begin{bmatrix}[rrr]3&1&0\\1&3&0\\0&0&4\\\end{bmatrix} \]
	Matrix $A$ has the minimum polynomial $f(t)=(t-2)(t-5)$ and $B$ has $g(t)=(t-4)^2(t-2)$. Thus $\Delta(t)=(t-2)^2(t-5)(t-4)^2$ but $m(t)=(t-2)(t-4)(t-5)$.
	\end{enumerate}
