...
\item[7.74]Consider $P(t)$ with inner product $\langle f,g \rangle = \int_{-1}^1f(t)g(t)dt$.
	...
	\begin{align*}
	c_1 &= \frac{\langle v,u_1 \rangle}{\langle 1,1 \rangle} = \\
	c_2 &= \frac{\langle v,u_2 \rangle}{\langle t,t \rangle} = \\
	c_3 &= \frac{\langle v,u_3 \rangle}{\langle 3t^3-1,3t^2-1 \rangle} = \\
	c_2 &= \frac{\langle v,u_4 \rangle}{\langle 5t^3-3t,5t^3-3t \rangle} = \\
	\end{align*}
	\end{enumerate}
